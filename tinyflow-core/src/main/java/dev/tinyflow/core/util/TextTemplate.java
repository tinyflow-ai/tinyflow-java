...
public class TextTemplate {
     ...
     * 模板缓存（按原始模板字符串）
     */
    private static final Map<String, TextTemplate> TEMPLATE_CACHE = new ConcurrentHashMap<>();
    ...
    public static TextTemplate of(String template) {
        ...
        return MapUtil.computeIfAbsent(TEMPLATE_CACHE, finalTemplate, k -> new TextTemplate(finalTemplate));
    }
