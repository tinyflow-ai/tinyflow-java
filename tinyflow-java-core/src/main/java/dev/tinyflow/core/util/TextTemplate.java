...
public class TextTemplate {
    ...
    private static final Map<String, TextTemplate> CACHES = new ConcurrentHashMap<>();
    ...
    public static TextTemplate of(String template) {
        ...
        return MapUtil.computeIfAbsent(CACHES, finalTemplate, k -> new TextTemplate(finalTemplate));
    }
